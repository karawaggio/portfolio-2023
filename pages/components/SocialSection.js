...
function SocialSection() {
    return(
        <section id="connect" className="xs-max:mt-0.8rem xs-min:m-4 md-min:p-12 p-4 bg-white rounded">
                ...
                <a href="#">
                  <div className="md-xl:grid md-xl:grid-cols-social-gridlg md-xl:gap-x-8 md-xl:my-4 md-xl:pt-2 md-xl:pl-4 md-xl:pr-2 md2-xl:m-0 xl:p-2">
                    ...
                    <div className="md-min:py-3">
                      ...
                      {/* <a className="main-btn resume-btn" href="resume/sergey-karavaev-resume.pdf" target="_blank">Resume</a> */}
                    </div>
                  </div>
                </a>
                </li>
